...
<template>
  <div>
    ...
    <B24PageSection
      ...
      :features="[
        ...
        },
        {
          ...
          description: 'Enterprise-ready architecture with proper error handling, and security best practices built-in.'
        }
      ]"
    />
    ...
    <B24PageSection>
      <B24PageCard
        title="Starting a new Nuxt app?"
        description="Join the community of developers building with Nuxt and Bitrix UI. Use the ready‑made starter template. Build and ship faster."
        variant="tinted-alt"
        :b24ui="{
          title: 'sm:text-5xl',
